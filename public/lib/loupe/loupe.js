        ...
        Loupe.prototype = {
            ...
            */
            render: function () {
                ...
                _this.obj = document.getElementById('memorialGallery');
                _this.lens.className += ' ' + _this.classes.lens;
                _this.obj.appendChild(_this.lens);
            },
            ...
            */
            refresh: function () {
                ...
                if (_this._.e) {
                    ...
                    var x = (event.pageX - $('#memorialGallery').offset().left) + $(window).scrollLeft();
                    var y = (event.pageY - $('#memorialGallery').offset().top);
